...
const AddCategory = ({ onNewCategory }) => {
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: onAddCategory, children: [
    /* @__PURE__ */ jsx("input", { type: "text", name: "name", placeholder: "Buscar Gif", value: inputValue, onChange: onInputChange }),
    /* @__PURE__ */ jsx("button", { type: "submit", children: "Buscar" })
  ] });
};
const GifGridItem = ({ title, url }) => {
  return /* @__PURE__ */ jsxs("div", { className: "card", children: [
    /* @__PURE__ */ jsx("img", { src: url, alt: title }),
...
const GifGrid = ({ category }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    isLoading && /* @__PURE__ */ jsx("div", { children: "Cargando...." }),
    images.length > 1 ? /* @__PURE__ */ jsx("div", { className: "card-grid", children: images.map((image) => /* @__PURE__ */ jsx(GifGridItem, { ...image }, image.id)) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("h4", { children: "...No se encontraron imagenes!!!" }),
      /* @__PURE__ */ jsx("hr", {})
    ] })
  ] });
};
const GifExpertApp = () => {
  const [categories, setCategories] = reactExports.useState(["DragonBall"]);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h1", { children: "GifExpertApp" }),
    /* @__PURE__ */ jsx(AddCategory, { onNewCategory: onAddCategory }),
    categories.map((category) => /* @__PURE__ */ jsx(GifGrid, { category }, category))
  ] });
};
const styles = "";
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(GifExpertApp, {}) })
);
